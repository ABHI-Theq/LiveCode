        ...
        hover:shadow-[0_10px_30px_rgba(233,63,63,0.15)]">
         ...
         <Button
          ...
          <div className="flex flex-col">
            <h1 className="text-xl font-bold text-[#e93f3f]">Open Your Github Repo</h1>
            <p className="text-sm text-muted-foreground max-w-[220px]">Work and play with your repositries</p>
          </div>
        </div>
